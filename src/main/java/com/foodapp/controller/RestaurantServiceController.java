...
public class RestaurantServiceController {
	...
	@PostMapping("/add")
	public ResponseEntity<Restaurant> saveResturant(@Valid @RequestBody Restaurant restaurant,@RequestParam String key) throws RestaurantException, AuthorizationException {
	...
	@PutMapping("/update")
	public ResponseEntity<Restaurant> updateResturant(@Valid @RequestBody Restaurant restaurant,@RequestParam String key) throws RestaurantException,AuthorizationException{
		String role = userSessionService.getUserRole(key); // Get the role
	...
	public ResponseEntity<Restaurant> deleteRestaurant(@PathVariable("restaurantId") Integer restaurantId,@RequestParam String key) throws RestaurantException,AuthorizationException{
